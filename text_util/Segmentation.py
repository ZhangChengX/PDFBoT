...
class SentenceSegmentation(object):
    ...
    def segment(self, text):
        return text_util.segment_by_sentence(text, 'zh')
...
class SentenceSegmentationEn(object):
    """ 分句 """
...
class Segmentation(object):
    ...
    def __init__(self, stop_words_file = None, 
        ...
        if delimiters == util.sentence_delimiters_en:
            self.ss = SentenceSegmentationEn()
        else:
